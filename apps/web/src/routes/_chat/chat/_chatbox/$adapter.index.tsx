...
export const Route = createFileRoute("/_chat/chat/_chatbox/$adapter/")({
  ...
  head: ({ params }) => ({
    meta: [
      {
        title: `Chat | ${params.adapter.charAt(0).toUpperCase() + params.adapter.slice(1)} | Envostart`,
      },
      {
        name: "Envostart",
      ...
      {
        property: "og:title",
        content: `Chat | ${params.adapter.charAt(0).toUpperCase() + params.adapter.slice(1)} | Envostart`,
      },
      {
